...
def get_openai_credentials(path='LettiNote/MediNote/generation/keys.json'):
    if not os.path.exists(path):
        #LettiNote/MediNote/generation/keys.json
    ...
    #openai.organization = keys['organization'] myAdd
    return keys
...
openai_client = openai.AsyncOpenAI(api_key = keys['api_key'])  #myadd
# NOTE: comment out key due to TypeError: 'NoneType' object is not subscriptable
